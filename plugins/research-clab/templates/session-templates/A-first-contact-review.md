...
/clab-review sessions/session-01/source-material.md

# Targeted subset (4-6 agents relevant to the new topic)
/clab-review sessions/session-01/source-material.md --agents principalist,calculator,workhorse-1,workhorse-2,skeptic,bridge

# First pass only (skip synthesis to see raw assessments before reframing)
/clab-review sessions/session-01/source-material.md --skip-synthesis

# Reframing pass (after reviewing first-pass results, run a second review)
/clab-review sessions/session-02/reframing-directive.md --agents principalist,calculator,workhorse-1,workhorse-2,skeptic,bridge
```
