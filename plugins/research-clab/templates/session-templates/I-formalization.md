...
/clab-review sessions/session-15/session-15-formalization.md

# Step 3 (optional): Targeted review if specific domains need deeper scrutiny
/clab-review sessions/session-15/session-15-formalization.md --agents workhorse-1,bridge,workhorse-2 --skip-synthesis
```
