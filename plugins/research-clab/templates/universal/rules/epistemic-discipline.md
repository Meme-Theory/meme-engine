...
1. **Structural constraints** are permanent. A proven theorem, an exact invariant, a ruled-out class of solutions — these define the walls of the solution space. They survive regardless of the framework's empirical fate. Report them as geometry: "The allowed region excludes all candidates of class X."
