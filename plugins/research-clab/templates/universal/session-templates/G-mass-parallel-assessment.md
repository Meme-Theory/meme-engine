...
Mass parallel assessment IS what `/rclab-review` was built for:
...
**Scaling the fan-out**: `/rclab-review` launches agents in batches of 5-6 (three batches). The full 17-agent roster produces 150-400 lines per agent = 2,500-6,800 lines of independent analysis, then auto-synthesizes into a master collab.
...
/rclab-review sessions/session-19/session-19d-calculator-collab.md --agents dreamer,observer
/rclab-review sessions/session-19/session-19d-dreamer-collab.md --agents calculator,observer

# Step 3: Master synthesis (panel assembles the master collab from all reviews)
/rclab-team sessions/session-plan/session-19d-master-prompt.md --mode panel --team-name s19d-master
```
