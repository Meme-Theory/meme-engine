...
class AstroqueryUniversal(BaseDataSource):
    ...
    def __init__(self, base_dir: str = None):
        ...
        self._discovered = False  # Lazy: defer heavy imports until first use
    
    def _ensure_discovered(self):
        """Trigger service discovery on first access (lazy init)."""
