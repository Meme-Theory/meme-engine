...
Research projects often want exact rational/algebraic answers (integer
factorizations, symbolic eigenvalues, closed-form integrals and sums) instead
of floating point. This server gives agents that option.
"""
...
USER_AGENT = "research-clab/Sage-MCP"
HTTP_TIMEOUT = 60.0
